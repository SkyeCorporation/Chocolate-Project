...
const botInstance = process.env.BOT_INSTANCE;
const accountSuffix = botInstance === "rem" ? "2"
        : botInstance === "shary" ? "3"
        : "";
const dirAccount = path.normalize(`${__dirname}/account${accountSuffix}${['production', 'development'].includes(NODE_ENV) ? '.dev.txt' : '.txt'}`);
